...
// cosign still requires the former module path. crypto11 was renamed to
// eclipse-keypont/crypto11; use its current module declaration for resolution.
replace github.com/ThalesIgnite/crypto11 => github.com/eclipse-keypont/crypto11 v1.6.8

// Newer kube-openapi releases use structured-merge-diff/v7, whereas the
// Kubernetes packages selected by cosign use v6.
